  ...
  return (
    <div className="mx-auto bg-[#fefefe]">
      <div className="relative flex flex-col items-center justify-center">
        ...
        <span className="absolute text-3xl font-semibold text-white sm:text-5xl font-logo">
          About Us
        </span>
      </div>
      <section className="px-4 py-6 mx-auto sm:py-12 max-w-7xl">
        ...
        <div className="flex flex-col items-center gap-2 my-6 md:gap-4">
          <div className="flex flex-col gap-6 py-6 items-center lg:flex-row">
            <div className="flex flex-col justify-center gap-2 md:gap-4 md:px-12">
              ...
              <hr className="pb-2" />
              <p className="text-lg">
                Since our establishment in 2009, Triple C Collective has been
                committed to providing a diverse range of high-quality products
                and exceptional service to both medicinal and recreational
                cannabis enthusiasts. Our enduring presence in the industry
                reflects our passion for cultivating a welcoming environment
                where everyone can explore the benefits of cannabis in a safe
          ...
          <div className="flex flex-col gap-6 py-6 items-center lg:flex-row">
            <div className="flex flex-col justify-center gap-2 md:gap-4 md:px-12">
              ...
              <p className="text-lg">
                ...
                offering a variety of strains, edibles, and other cannabis
                products to cater to every preference.
              </p>
            </div>
            <Image
              src="/images/generic-blog.jpg"
          ...
          <div className="flex flex-col gap-6 py-6 items-center lg:flex-row-reverse">
            <div className="flex flex-col justify-center gap-2 md:gap-4 md:px-12">
              ...
              <hr className="pb-2" />
              <p className="text-lg">
                In addition to our extensive cannabis collection, we are excited
                to offer a selection of kratom and premium CBD products. These
                alternatives complement our commitment to holistic well-being,
                providing options for those looking for diverse wellness
                solutions.
              </p>
            </div>
            <Image
        ...
        <div className="max-w-4xl py-16 mx-auto">
          <p className="max-w-4xl mx-auto text-xl font-semibold text-center md:text-2xl text-pretty">
            Thank you for being a part of the Triple C Collective family. Your
            well-being is our priority, and we look forward to serving you for
