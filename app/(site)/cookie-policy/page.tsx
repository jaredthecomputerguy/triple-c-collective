...
export default function CookiePolicyPage() {
    return (
        <section className='max-w-4xl mx-auto sm:py-12 py-6 px-2'>
            <h1 className='text-4xl py-4 font-semibold'>Cookie Policy</h1>
            <span className='text-center text-gray-700 mx-auto py-2'>Last Updated: 12/31/2023</span>
            <hr className='pb-4' />
            <article className='pb-6'>
                <h2 className='text-3xl py-2'>What Are Cookies</h2>
                <p>
                ...
                <br />
                <p>
                    It is recommended that you leave on all cookies if you are not sure whether you need them or not in
                    case they are used to provide a service that you use.
                </p>
                <br />
                <h4 className='text-3xl py-2'>Disabling Cookies</h4>
                <p>
                ...
                <p>
                    ...
                    features of the this site.
                </p>
                <br />
                <p>Therefore it is recommended that you do not disable cookies.</p>
                <br />
                <h5 className='text-3xl py-2'>The Cookies We Set</h5>
                <p>
                ...
                <br />
                <p>
                    However if you are still looking for more information then you can contact us via our{' '}
