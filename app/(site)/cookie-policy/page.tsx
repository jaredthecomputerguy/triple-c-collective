  ...
  return (
    <div className="max-w-4xl mx-auto sm:py-12 py-6 bg-[#fefefe] px-4 prose-a:text-blue-600 prose prose-h5:font-semibold prose-h6:text-[#111827] prose-h5:text-[#111827] prose-h6:font-semibold">
      ...
      <article className="pb-6">
        ...
        <p>
          This page describes what information they gather, how we use it and why we sometimes need to store these
          cookies. We will also share how you can prevent these cookies from being stored however this may downgrade or
