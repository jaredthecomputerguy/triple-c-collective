...
export const SpecialArtPromo = ({ active }: { active: boolean }) => {
  if (!active) {
    return null;
  }
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex gap-2">
            <Link
              ...
              target="_blank"
              className="group rounded-full bg-white p-1 hover:bg-linear-to-br hover:from-[#f9ce34] hover:via-[#ee2a7b] hover:to-[#6228d7]">
