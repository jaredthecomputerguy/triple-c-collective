...
export default function TermsOfUsePage() {
  return (
    <main
      className="max-w-4xl mx-auto sm:py-12 py-6 pb-8 prose-a:text-blue-600 prose prose-h5:font-semibold prose-h6:text-[#111827] prose-h5:text-[#111827] prose-h6:font-semibold bg-[#fefefe] px-4"
      id="main-content">
      <div>
      ...
      <p>
        By accessing or using the Triple C Collective website, you agree to be bound by these Terms of Use and all
        applicable laws and regulations. If you do not agree with any part of these terms, please do not use our
        website.
      </p>{" "}
      <h3 className="py-2 text-3xl">2. Age Restriction</h3>{" "}
      <p>
        You must be at least 21 years old, or 18 years old with a valid medical recommendation, to use this website. By
        accessing and using this site, you confirm that you are of legal age to purchase cannabis products.
      </p>{" "}
      <h4 className="py-2 text-3xl">3. Compliance with Laws</h4>{" "}
      <p>
        You agree to comply with all applicable federal, state, and local laws and regulations regarding the use of
        cannabis and related products. Triple C Collective reserves the right to refuse service to anyone for any reason
        at any time.
      </p>{" "}
      ...
      <h6 className="py-2 text-3xl">6. Prohibited Activities</h6> You agree not to engage in any activities that may be
      deemed illegal, including but not limited to:
      ...
      <p>
        All content on this website, including text, graphics, logos, images, and software, is the property of Triple C
        Collective and is protected by copyright and other intellectual property laws. You may not reproduce, modify,
        distribute, or republish any content without our written consent.
      </p>{" "}
      ...
      <p>
        ...
        responsibility to check for updates periodically. Your continued use of the website after changes constitutes
