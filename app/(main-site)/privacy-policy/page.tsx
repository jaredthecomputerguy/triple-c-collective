      ...
      <section className="prose prose-h5:font-semibold prose-h5:text-[#111827] prose-h6:font-semibold prose-h6:text-[#111827] prose-a:text-blue-600 mx-auto max-w-4xl bg-[#fefefe] px-4 py-6 sm:py-12">
        ...
        <article className="pb-6">
            ...
            <li>
              ...
              <ul className="list-disc px-4">
                <li>
                  ...
                  request, such as responding to inquiries, processing orders,
            ...
            <li>
              ...
              <ul className="list-disc px-4">
                <li>
                  ...
                  about our products, services, promotions, and important
          ...
          <p>
            ...
            . Thank you for trusting YCNIUQ Inc. dba Triple C Collective with
            your information.
          </p>
        </article>
      </section>
