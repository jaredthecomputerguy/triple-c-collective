        ...
        <section className="w-full bg-[#F3F4F6] py-6 md:py-12 lg:py-18">
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="max-w-87.5 space-y-4 sm:max-w-none">
        ...
        <section
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
              <div className="max-w-87.5 space-y-4 text-white sm:max-w-none">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground max-w-225 pb-2 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
